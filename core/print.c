...
int isquote = 0;
/**
* quoting - detects quoting in the input
* @buff: the string to analise
* Return: 0 if success
*/
...
/**
* check_keywords - detects keywords an set a color
* @buff: the string to analise
* Return: 1 if success
*/
...
{
	int pos = 0;
	char *blue = "\033[34m", *red = "\x1b[38;5;9m";
	char *yellow = "\x1b[38;5;202m", *green = "\x1b[38;5;40m";
	char *qoutes = "\x1b[38;5;76m", *cyan = "\x1b[38;5;92m";
...
/**
* console_log - print to the log file
* @string: log content
*/
